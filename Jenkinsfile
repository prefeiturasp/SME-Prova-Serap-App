      ...
      stage('Build APK Dev') {
        ...
        steps {
          withCredentials([
            ...
            sh 'rm pubspec.lock && flutter clean && flutter upgrade && flutter pub get && flutter packages pub run build_runner build --delete-conflicting-outputs && flutter build apk --release'
          }
        }
      }
