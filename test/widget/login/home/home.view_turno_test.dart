...
import 'package:appserap/database/daos/jobs.dao.dart';
import 'package:appserap/database/daos/prova.dao.dart';
...
void main() {
  ...
  mockProvaComTempo(MockProvaService mock, {bool forcarBaixada = false}) async {
    ...
    for (var item in json) {
      ...
      if (forcarBaixada) {
        ...
        provaModel.downloadStatus = EnumDownloadStatus.CONCLUIDO;
