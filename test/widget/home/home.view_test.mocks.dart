...
class MockPrincipalStore extends _i1.Mock implements _i9.PrincipalStore {
  ...
  @override
  _i10.Future<void> setup() => (super.noSuchMethod(
        Invocation.method(
          #setup,
          [],
        ),
  ...
  @override
  _i10.Future<String?> obetIdDispositivo() => (super.noSuchMethod(
        Invocation.method(
          #obetIdDispositivo,
          [],
        ),
  ...
  @override
  _i10.Future<void> obterVersaoDoApp() => (super.noSuchMethod(
        Invocation.method(
          #obterVersaoDoApp,
          [],
        ),
  ...
  @override
  _i10.Future<void> sair() => (super.noSuchMethod(
        Invocation.method(
          #sair,
          [],
        ),
