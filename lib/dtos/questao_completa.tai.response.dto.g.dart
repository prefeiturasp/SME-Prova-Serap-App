...
part of 'questao_completa.tai.response.dto.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

QuestaoCompletaTaiResponseDTO _$QuestaoCompletaTaiResponseDTOFromJson(
    ...
    QuestaoCompletaTaiResponseDTO(
      ...
      alternativas: (json['alternativas'] as List<dynamic>)
          .map((e) =>
              AlternativaTaiResponseDTO.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$QuestaoCompletaTaiResponseDTOToJson(
        QuestaoCompletaTaiResponseDTO instance) =>
    <String, dynamic>{
      'id': instance.id,
