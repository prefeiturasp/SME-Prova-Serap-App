...
class ApresentacaoContextoAdminWidget extends StatelessWidget {
  final BaseStatefulWidget? avancarParaPagina;
  final List<ContextoProvaResponseDTO> listaDePaginasContexto;
  ...
  ApresentacaoContextoAdminWidget({
  ...
  Widget _builderImagemComPosicionamento(int posicionamento, String urlImagem, BuildContext context) {
    ...
    return Container(
      child: Image.network(urlImagem, alignment: posicao),
  ...
  _builderPaginaContexto(
    ...
    return ListView(
      children: [
        _builderImagemComPosicionamento(posicionamento, urlImagem, context),
